...
sleep 5
echo ""
toilet -f big -F gay TRISNA F.
echo $green">"
echo $white"Author : TRISNA713"
echo $green"Tempat Tinggal : Banten"
echo $purple"Email : trisnaky713@gmail.com"
echo $red"Website : trisnablog.eu.org"
echo $blue"Facebook : Nukkit"
echo $green">"
echo $yellow"Thanks For : Allah S.W.T"
echo $green">"
echo $cyan
figlet "PART 1"
echo ""
